...
if __name__ == "__main__":
    ...
    model_name = "meta-llama/Llama-3.1-8B"  # Replace with the desired model
    ...
    # Step 5: Load knowledge base and process a sample query
    ...
    print(f"Cache directory: {neural.tokenizer.cache_dir}")
